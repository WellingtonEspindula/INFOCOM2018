...
def evalTopo():
  ...
  linkopts1 = dict(bw=0.5, delay='150ms' )
  ...
  net.addLink(s1, s3, **linkopts1 )
  net.addLink(s1, s4, **linkopts2 )
  net.addLink(s1, s5)
  net.addLink(s2, s6)
  net.addLink(s2, s7)
  net.addLink(s2, s8, **linkopts3 )
  net.addLink(s3, s9)
  net.addLink(s4, s9)
  net.addLink(s5, s10)
  net.addLink(s6, s11)
  ...
  #Level 2 - Access
  net.addLink(s9, s13, **linkopts1 )
  net.addLink(s9, s14)
  net.addLink(s10, s13)
  net.addLink(s10, s14, **linkopts3 )
  net.addLink(s11, s13)
  net.addLink(s11, s14)
  net.addLink(s12, s13)
  net.addLink(s12, s14, **linkopts2 )
